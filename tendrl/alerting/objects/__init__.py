...
class AlertingBaseObject(BaseObject):
    def __init__(
            self,
            attrs=None,
            enabled=None,
        ...
        super(AlertingBaseObject, self).__init__(
            attrs=None,
            enabled=None,
            obj_list=None,
            obj_value=None,
        ...
        # ['Node.cmd_str']}, 'run': 'tendrl.alerting.atoms.node.cmd.Cmd',
        ...
        # 'run': 'tendrl.alerting.atoms.node.check_node_up',
