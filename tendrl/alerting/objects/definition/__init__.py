...
from tendrl.alerting.objects.definition import alerting
...
class Definition(objects.BaseObject):
    def __init__(self, *args, **kwargs):
        ...
        self.value = '_tendrl/definitions/alerting'
        self.alerting = alerting.data
        self._parsed_defs = yaml.safe_load(self.alerting)
...
class _DefinitionEtcd(etcdobj.EtcdObj):
    ...
    """
    __name__ = '_tendrl/definitions/alerting'
